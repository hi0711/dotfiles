...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.0.0/x86_64-darwin13.4.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/hi0711/.rbenv/versions/2.0.0-p594")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/hi0711/.rbenv/versions/2.0.0-p594' '--with-openssl-dir=/usr/local/opt/openssl' '--with-readline-dir=/usr/local/opt/readline' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/hi0711/.rbenv/versions/2.0.0-p594/lib ' 'CPPFLAGS=-I/Users/hi0711/.rbenv/versions/2.0.0-p594/include '"
  ...
  CONFIG["arch"] = "x86_64-darwin13.4.0"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/hi0711/.rbenv/versions/2.0.0-p594/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/hi0711/.rbenv/versions/2.0.0-p594/lib "
  ...
  CONFIG["target"] = "x86_64-apple-darwin13.4.0"
